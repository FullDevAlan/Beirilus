...
Berillo’s Barbearia.
  ...
  return (
    <div className="h-100 ">
      <Header />
      <div
        className="bg d-flex flex-column justify-content-end align-items-center"
        style={{ paddingBottom: 80, height: "90%" }}
      >
        <h5 className="text-center mb-5">
          Valorize seu tempo e agende conosco.
          <br />
          Os melhores serviços na melhor barbearia!
        </h5>
        <button className="btn btn-primary btn-lg" onClick={redirectToSchedule}>
          Agendar
        </button>
      ...
      <div
        className="bg2 d-flex justify-content-center align-items-center p-1 "
            ...
            <>
              {detailsWorker && (
                <>
                  {item.name == detailsWorker.name ? (
                    ...
                    <>
                      <div
                        className="card-hidden card bg-white m-2 d-flex justify-content-center"
              ...
              {!detailsWorker && (
                <div className={`card bg-white m-2 `} style={{ width: 400 }}>
                  <img width={380} src={item.image} />
                  <img
                    src={item.name == "Paulo Henrique" ? cut1 : cut2}
                    style={{
                      position: "absolute",
                      width: "auto",
        ...
        <div className="row">
          ...
          >
            ...
            <p className="text-gray">
              O foco de atendimento da Berillo's Barbearia é o público masculino
              adulto, mas também atendemos crianças. Por isso, traga seu filho,
              seu sobrinho, seu neto e venha passar momentos agradáveis conosco.
              <br />
              <br />
              Nosso time de profissionais sempre busca ampliar o casting de
              cortes e barbas, além de se atualizar sobre os melhores
              procedimentos estéticos. Tudo para oferecer a você serviços de
              qualidade.
              <br />
              <br />
              Para um atendimento personalizado, oferecemos a possibilidade de
              você fazer o seu agendamento de maneira antecipada. Já agendou o
              seu horário?
            </p>
            <p className="text-gray">
              <b>Alessandro Ramos</b> - ~ Berillo´s Barbearia
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="row p-4">
          <div className="col-10">
            <h5 className="text-black">
              Entre em contato e consulte nossa agenda
            </h5>
            <p className="text-black">
              Consulte também agenda de atendimento para feriados, dias
              promocionais e descontos em datas comemorativas
            </p>
          </div>
